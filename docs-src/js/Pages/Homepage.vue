			...
			talkingPoints(){
				return [
					...
					},
					{
						...
						desc: 'The middleware pipeline provides a flexible solution for handling asynchronous requests during routing.',
						examples: [
					...
					},
					{
						...
						desc: 'Designed to use with reactive frameworks.',
						examples: [],
						link: 'vuejs.org',
						linkTitle: 'Download',
					},
					{
						color: '#1aa2ed',
						icon: 'fa fa-gem',
						title: 'Get Collect.js',
						desc: 'A Javascript Gem ready for your projects.',
						examples: [],
						link: 'github.com/ecrmnn/collect.js',
						linkTitle: 'Download',
					},
				]
			}
